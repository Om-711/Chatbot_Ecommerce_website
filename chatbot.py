...
# async def async_invoke_chain(chain, context, question):
...
#         result = loop.run_until_complete(async_invoke_chain(chain, context, question))
...
# @app.get("/chat/ai")
# def chat_ai_endpoint(user_id: str, question: str):
#     response = chat_ai(user_id, question)
#     return JSONResponse(response)

# remove any manual loop creation at module level
